      ...
      <div class="modal-container">
        ...
        <div class="modal-body">
          ...
          <div class="mb-6">
            ...
            <textarea id="moderationNotes" v-model="moderationNotes" rows="3"
          ...
          <div class="flex justify-end gap-3">
            ...
            <button v-if="!reportedPost.reportResolved" @click="approvePost"
              class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition-colors">
              Approve Post
            </button>
            <button v-if="!reportedPost.reportResolved" @click="deletePost"
              class="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600 transition-colors">
              Delete Post
            </button>
            <button v-if="reportedPost.reportResolved" disabled
  ...
  watch: {
    show(val) {
      if (val) {
        ...
        this.fetchReportDetails(this.postId); // <-- ADD THIS
      }
    },
    postId(val) {
      if (val && this.show) {
        this.fetchReportedPost();
        this.fetchReportDetails(val); // <-- ADD THIS
      }
    }
  },
  methods: {

        ...
        <div class="modal-body">
          ...
          <div class="bg-amber-50 border-l-4 border-amber-500 p-4 mb-6">
            ...
            <div class="mt-2 ml-7 text-sm text-amber-700">
              <p><span class="font-semibold">Reported by:</span> {{ post.reportedBy }}</p>
              <p><span class="font-semibold">Reason:</span> {{ post.reportReason }}</p>
              <p><span class="font-semibold">Date reported:</span> {{ formatDate(post.reportDate) }}</p>
            </div>
          </div>
          ...
          <div class="post-content mb-6 border border-gray-200 rounded-lg p-4 bg-gray-50">
          ...
          <div class="flex justify-end gap-3">
            ...
            <button @click="approvePost" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition-colors">
              Approve Post
            </button>
            <button @click="deletePost" class="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600 transition-colors">
              Delete Post
            </button>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    approvePost() {
      // Send the moderation notes and action to the parent component
      this.$emit('approve', {
        postId: this.post.id,

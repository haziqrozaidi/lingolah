<template>
  <div class="sidebar-left sticky top-5 h-fit space-y-5">
    <div class="filter-section bg-white rounded-xl shadow-sm p-4">
      <div class="filter-option flex items-center p-3 rounded-lg mb-2 cursor-pointer transition-all bg-blue-500 text-white">
      ...
      <div class="filter-option flex items-center p-3 rounded-lg cursor-pointer transition-all hover:bg-gray-50">
        ...
        <div class="filter-text ml-3">
          <div class="filter-title-with-badge flex items-center"><span class="filter-title text-sm font-semibold text-blue-500">Following</span>
          </div>
